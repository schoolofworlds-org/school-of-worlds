        ...
        <div className="bg-white border border-[#E5DDD0] rounded-xl shadow-[0_4px_20px_rgba(11,18,32,0.04)] p-6 md:p-12 flex flex-col items-center">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-base text-[#605e58] opacity-80">
              Create an account to begin building worlds.
            </p>
          </div>
          ...
          <form action={signup} className="w-full space-y-6">
            {/* Full Name */}
            <div className="space-y-1">
              <label htmlFor="name" className="block px-1 text-sm font-semibold tracking-[0.05em] text-[#45474c]">
                Full Name
              </label>
              <div className="relative">
                <User size={20} className="absolute left-4 top-1/2 -translate-y-1/2 text-[#c6c6cc]" />
                <input
                  id="name"
                  name="name"
                  type="text"
            ...
            {/* Email */}
            <div className="space-y-1">
              <label htmlFor="email" className="block px-1 text-sm font-semibold tracking-[0.05em] text-[#45474c]">
                Email Address
              </label>
              <div className="relative">
            ...
            {/* Password — reused field, no forgot link, 6-char min + helper */}
            <PasswordField forgot={false} minLength={6} helpText="At least 6 characters" />
          ...
          <div className="mt-20 w-full text-center space-y-6">
            ...
            <p className="text-base text-[#605e58]">
              ...
              <a href="/login" className="text-black font-semibold hover:underline underline-offset-4">
                Sign in
              </a>
            </p>
          </div>
